...
```bash
# Search flights
curl "https://mcp.valorflights.com/api/flights/search?origin=JFK&destination=LHR&departure_date=2025-07-15"

# Cheapest dates
curl "https://mcp.valorflights.com/api/flights/cheapest?origin=LAX&destination=NRT&month=2025-08"

# Price calendar
curl "https://mcp.valorflights.com/api/flights/calendar?origin=SFO&destination=CDG&month=2025-09"

# Booking link
curl "https://mcp.valorflights.com/api/flights/booking-link?origin=ORD&destination=BCN&departure_date=2025-06-20"
```
